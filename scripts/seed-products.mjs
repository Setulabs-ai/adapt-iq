...
const productsToInsert = [
  ...
  { id: "clothing_101", store_id: "store_123", name: "Classic White Oxford Shirt", price: "$49.99", image: "https://images.unsplash.com/photo-1596755094514-f87e32f85e2c?q=80&w=400&auto=format&fit=crop", description: "A timeless, crisp white oxford shirt perfect for business or casual wear. 100% cotton.", tags: ["clothing", "shirt", "tops", "cotton", "casual", "business"] },
